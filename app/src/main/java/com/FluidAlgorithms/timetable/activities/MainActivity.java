...
import com.FluidAlgorithms.timetable.adapters.FragmentsTabAdapter;
import com.FluidAlgorithms.timetable.fragments.FridayFragment;
import com.FluidAlgorithms.timetable.fragments.MondayFragment;
import com.FluidAlgorithms.timetable.fragments.SaturdayFragment;
import com.FluidAlgorithms.timetable.fragments.SundayFragment;
import com.FluidAlgorithms.timetable.fragments.ThursdayFragment;
import com.FluidAlgorithms.timetable.fragments.TuesdayFragment;
import com.FluidAlgorithms.timetable.fragments.WednesdayFragment;
import com.FluidAlgorithms.timetable.R;
import com.FluidAlgorithms.timetable.utils.AlertDialogsHelper;
import com.FluidAlgorithms.timetable.utils.DailyReceiver;

import java.util.Calendar;

import static com.FluidAlgorithms.timetable.utils.BrowserUtil.openUrlInChromeCustomTab;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.links:
                Intent links = new Intent(MainActivity.this, Links.class);
                startActivity(links);
                return true;
